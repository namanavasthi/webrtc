...
?>
        ...
        <article>
            ...
            <section class="experiment">                
                <section>
                    <span>
                        <a href="/video-conferencing/index.html" target="_blank" title="Open this link in new tab. Then your conference room will be private!"><code><strong id="unique-token">Click Me</strong></code></a>
                    </span>
            ...
            <script>
                ...
                (function() {
                    ...
                    if (uniqueToken)
                        ...
                        else uniqueToken.parentNode.parentNode.href = 'index.html#' + (Math.random() * new Date().getTime()).toString(36).toUpperCase().replace( /\./g , '-');
                })();
